...
Shader "czw/Test/RenderFeature"
{
	Properties
	{
		...
		[ASEEnd]_MinColor("_MinColor", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( _MinColor * tex2D( _MainTex, uv_MainTex ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19001
210;479;1082;540;681;210;1;True;True
