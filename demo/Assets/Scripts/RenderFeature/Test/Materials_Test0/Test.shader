...
Shader "czw/Test/RenderFeature"
{
	Properties
	{
		...
		_TestureRT("_TestureRT", 2D) = "white" {}
		_MinColor("_MinColor", Color) = (1,1,1,0)
		[ASEEnd][Toggle(_ISMAINTEX_ON)] _IsMainTex("IsMainTex", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_TestureRT = IN.ase_texcoord3.xy * _TestureRT_ST.xy + _TestureRT_ST.zw;
				float2 uv_MainTex = IN.ase_texcoord3.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				#ifdef _ISMAINTEX_ON
				float4 staticSwitch15 = tex2D( _MainTex, uv_MainTex );
				#else
				float4 staticSwitch15 = tex2D( _TestureRT, uv_TestureRT );
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _MinColor * staticSwitch15 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19001
7;120;1920;891;1100;385.5;1;True;False
Node;AmplifyShaderEditor.ColorNode;13;-304,-185;Inherit;False;Property;_MinColor;_MinColor;2;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;14;-495,8.5;Inherit;True;Property;_TestureRT;_TestureRT;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;36,-110;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;10;-493,202;Inherit;True;Property;_MainTex;_MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StaticSwitch;15;-179,25.5;Inherit;False;Property;_IsMainTex;IsMainTex;3;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=5C025F0516CDD21A3EEAD119F32792C6F5096080