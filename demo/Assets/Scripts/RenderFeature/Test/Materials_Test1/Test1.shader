...
Shader "czw/Test/RenderFeature1"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		[ASEEnd][ASEBegin]_MinColor("_MinColor", Color) = (1,1,1,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _MinColor;
			float4 _TestRenderFeatureTex_ST;
			...
			sampler2D _TestRenderFeatureTex;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_TestRenderFeatureTex = IN.ase_texcoord3.xy * _TestRenderFeatureTex_ST.xy + _TestRenderFeatureTex_ST.zw;
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _MinColor * tex2D( _TestRenderFeatureTex, uv_TestRenderFeatureTex ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=19001
7;138;1920;873;1100;373.5;1;True;False
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;11;-30,-93;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;13;-304,-185;Inherit;False;Property;_MinColor;_MinColor;0;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;10;-339,26;Inherit;True;Global;_TestRenderFeatureTex;_TestRenderFeatureTex;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
