...
public class SSSSRenderFeature : ScriptableRendererFeature
{
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            //计算出SSSBlur的kernel参数
            Vector3 SSSC = Vector3.Normalize(new Vector3(setting.SubsurfaceColor.r, setting.SubsurfaceColor.g,
                setting.SubsurfaceColor.b));
            Vector3 SSSFC = Vector3.Normalize(new Vector3(setting.SubsurfaceFalloff.r, setting.SubsurfaceFalloff.g,
                setting.SubsurfaceFalloff.b));
