...
half4 LitPassFragment_Diffuse(Varyings input) : SV_Target
{
    ...
    half3 diffuse = Skin_SSSS_Diffuse(normalWS, mainLight, input.positionWS);
    half3 color = diffuse;
...
half4 LitPassFragment_Specular(Varyings input) : SV_Target
{
    ...
    half3 specular = Skin_SSSS_Specular(normalWS, viewDirWS, mainLight, roughnessFactor, specualrColor);
